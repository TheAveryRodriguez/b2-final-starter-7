...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it "discount_applied" do
      ...
      @invoice_1 = Invoice.create!(customer_id: @customer_1.id, status: 2, created_at: "2012-03-27 14:54:09")
      @ii_1 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 9, unit_price: 10, status: 2)
      @ii_11 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_8.id, quantity: 11, unit_price: 10, status: 1)
      ...
      expect(@invoice_1.discount_applied).to eq(22)
    end
    ...
    it "discounted_revenue" do
      ...
      expect(@invoice_1.discounted_revenue).to eq(178)
    end
  end
end
